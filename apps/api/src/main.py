...
from apps.api.src.routes import assistant, auto_accept, commercial, consent, feed_appeals, insight_aggregates, organisation_admin, organisation_overview, shift_changes, shift_offers, worker_certifications
...
app.include_router(venue_join_codes.router)
app.include_router(venue_people.router)
...
app.include_router(worker_time_off.router)
...
app.include_router(organisation_overview.router)
app.include_router(commercial.router)
app.include_router(consent.router)
app.include_router(insight_aggregates.router)
app.include_router(assistant.router)
app.include_router(feed_appeals.router)
